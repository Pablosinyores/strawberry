...
You will need [uv](https://docs.astral.sh/uv/) to start contributing to
Strawberry. Refer to the
[documentation](https://docs.astral.sh/uv/getting-started/installation/) to
install uv.
